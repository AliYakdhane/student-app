      ...
      <div class="card">
        <div class="card-body px-4 py-3">
          <div class="table-responsive">
            <form method="POST" action="process_add_course.php" enctype="multipart/form-data">
              <div class="mb-3">
              ...
              <?php
              // Get the teacher ID from the logged-in session
              $teacherId = $_SESSION['user_id'];
              
              // Pass the teacher ID as a hidden input field
